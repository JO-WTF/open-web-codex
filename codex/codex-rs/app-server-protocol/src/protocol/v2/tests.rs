...
#[test]
fn codex_error_info_serializes_provider_function_tools_unsupported_in_camel_case() {
    assert_eq!(
        serde_json::to_value(CodexErrorInfo::ProviderFunctionToolsUnsupported).unwrap(),
        json!("providerFunctionToolsUnsupported")
    );
}
