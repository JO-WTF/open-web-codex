...
- Use the map provider only to obtain navigation route facts. Final warehouse comparison maps come from the warehouse-network delivery capability so they preserve the exact normalized, baseline, facility and comparison inputs and the Platform-readable final descriptor.
