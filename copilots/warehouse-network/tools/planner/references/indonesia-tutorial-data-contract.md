...
- The current province owner is the 38-feature World Bank ADM1 release locked in
  `examples/indonesia-tutorial/source-lock.json`. Its bundled geometry is the
  generation boundary and is redistributed under CC BY 4.0.
...
`scripts/generate_indonesia_tutorial_data.py` writes one immutable release under
