...
4. When a visual map helps, call `map_utils.create_map_card` after obtaining coordinates or route geometry. Follow the MCP server's map-card output contract after a successful call.
