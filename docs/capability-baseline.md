...
| 文档性质 | 当前事实与证据 |
| 观察日期 | 2026-08-20 |
| 代码快照 | 阶段四仓网 E2E checkpoint（基于 `14d2f3e76`，含当前 Chat transport seam） |
